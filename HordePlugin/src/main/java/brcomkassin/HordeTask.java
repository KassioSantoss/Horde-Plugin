...
public class HordeTask extends BukkitRunnable {
    ...
    private final int particleCount = 25;
    ...
    public void hitMob() {
        ...
        if (livingEntityList.size() <= 3) {
            ...
            if (livingEntityList.size() <= 2) {
                Location spawnLocation = player.getLocation().clone().add(-4, -2.5, 0);
                LivingEntity livingEntity = customEntityManager.spawnEntity(CustomEntityType.ZOMBIE_HORDE, spawnLocation);
                livingEntity.setCollidable(false);
                livingEntityList.add(livingEntity);
            }
    ...
    public void activeAnimation(LivingEntity livingEntity) {
                ...
                if (value <= 1.5) {
                    ...
                    for (LivingEntity livingEntity : livingEntityList) {
                        ...
                        for (int i = 0; i < particleCount; i++) {
                            ...
                            Location spawnLocation = new Location(livingEntity.getWorld(), x,
                                    livingEntity.getLocation().clone().getY() -0.1 , z);
                            ...
                            transformation.getScale().set(0.5, 0.3, 0.5);
